...
if (error) {
  ...
  className={`px-2 py-0.5 rounded flex items-center gap-1 ${
    trial.status === "Submitted"
      ...
      : trial.status === "Under Review"
      ? "text-yellow-400 bg-yellow-950/40 border border-yellow-900/30"
      : trial.status === "Completed"
      ? "text-green-400 bg-green-950/40 border border-green-900/30"
      : "text-red-400 bg-red-950/40 border border-red-900/30"
  }`}
>
  {trial.status === "Submitted" && <Send className="w-2.5 h-2.5" />}
  {trial.status === "Under Review" && (
  ...
  {trial.status === "Rejected" && <X className="w-2.5 h-2.5" />}
