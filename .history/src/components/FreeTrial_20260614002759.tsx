...
}, 3000); // closes after 3 seconds alert(`Free Trial Request Submitted Successfully!\nTicket ID: ${ticketId}`);
                    ...
                    {activeTrials.map((trial) => (
                      ...
                      >
                        ...
                        <div className="mt-4 pt-3 border-t border-white/5 flex justify-between items-center text-[9px] font-mono">
                          ...
                          <span className="text-blue-400 bg-blue-950/40 border border-blue-900/30 px-2 py-0.5 rounded flex items-center gap-1">
