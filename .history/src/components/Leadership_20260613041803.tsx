...
import { User, Quote, ShieldCheck, Sparkles, Building2 } from "lucide-react";
            ...
            >
              ...
              <div>
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-5 pb-6 border-b border-white/5 mb-6">
                  ...
                  <div className={`w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-gradient-to-br ${exec.gradient} ${exec.ringColor} border flex items-center justify-center shadow-inner relative group-hover:scale-105 transition-transform duration-300 shrink-0`}>
                    <span className="font-display text-xl sm:text-2xl font-bold text-[#C8A46D] tracking-wider">
                      {exec.initials}
                    </span>
